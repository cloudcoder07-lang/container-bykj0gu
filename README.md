...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bykj0gu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bykj0gu.containers.anotherwebservice.com/
...
```
git clone git@github.com:cloudcoder07-lang/container-bykj0gu.git
cd container-bykj0gu
```
...
```
docker attach container-bykj0gu
```
